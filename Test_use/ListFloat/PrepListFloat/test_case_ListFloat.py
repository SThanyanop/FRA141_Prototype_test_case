...
Question = 'ListFloat'  # Have to match the name of the function in Question.py
...
def ListFloat_test(x,y): # Solution name should match the function name in Question.py but with _test suffix
    x += y
    x.sort()
    return x
...
basic_testcase.append(([1.234, 3.342, 1.2345, 0.7], [211.1, 6.4, 789.76, 4.8])) # Example of a basic test case
basic_testcase.append(([10.5, 20.3, 30.1], [5.2, 15.6, 25.8]))
basic_testcase.append(([2.5, 4.1, 6.3], [1.2, 3.4, 5.6]))

# Generate random basic test cases #
for i in range(0, 10): # Feel free to change the range
    basic_testcase.append((GenerateRandomFloatList(100.0),GenerateRandomFloatList(100.0))) # Feel free to change the max_value and min_value
...
for i in range(0, 12): # Feel free to change the range
    advance_testcase.append((GenerateRandomFloatList(1000.0,0.0,GenerateRandomInt(10)),GenerateRandomFloatList(1000.0,0.0,GenerateRandomInt(10)))) # Feel free to change the max_value and min_value
